<html>
    ...
    <?php
        ...
        <p class='heading'>List Of All Patients</p>
        ";

        echo "
        <div class='table'><table>
        <tr>
        <th class='thead'>PatientID</th>
        <th class='thead'>Patient Name</th>
        <th class='thead'>Patient Email</th>
        ...
        <td>$row[mobile]</td>
        <td class='btn'>
        <button class='edit'><a href='editpatient.php?id=$row[id]'>Edit</a></button>
        <button class='delete'><a href='deletepatient.php?id=$row[id]'>Delete</a></button>
        </tr>";}
        echo "</table></div></div>"
        ?>
