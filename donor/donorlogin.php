<html>
    ...
    <div class="contentbox">
        <div class="adminloginbox">
            <p class='adminlogin'>Donor Login</p><hr>
            <form action="donorchk.php">
                <input type="email" name="id" placeholder="Enter Email"><br>
                <input type="Password" name="pass" placeholder="Enter Password"><br>
                <input type="submit" value="Login" class="subbutton">
            </form>
            <p class='register' style="font-size: 14px;">Don't have an account, <a href='donorregistration.php'>Create here</a></p>
        </div></div>
